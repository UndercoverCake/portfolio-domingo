...
const projects = [
  ...
  },
  {
    ...
    image: "/Proj2.png?height=200&width=300&text=Project+2",
    link: "#",
  },
  {
    id: 3,
    title: "Laundry Management System",
    description: "Software engineering project that aimed to aid laundry service shops with inventory and tracking.",
    image: "/proj3.png?height=200&width=300&text=Project+3",
    link: "#",
  },
      ...
      <main className={styles.main}>
        <div className={styles.container}>
          ...
          <section className={styles.section} ref={(el) => (sectionRefs.current[1] = el)}>
            ...
            <p>I am a backend web developer specializing in Python and the Django framework. With a strong focus on building scalable, secure, and efficient web applications, I have experience designing and managing databases, and optimizing backend performance.
            </p>
          </section>
  
          <section className={styles.section} ref={(el) => (sectionRefs.current[2] = el)}>
          ...
          <section className={styles.section} ref={(el) => (sectionRefs.current[3] = el)}>
            ...
            <div className={styles.skillsContainer}>
              {["Web Development", "Project Management", "Graphic Designing"].map((skill) => (
